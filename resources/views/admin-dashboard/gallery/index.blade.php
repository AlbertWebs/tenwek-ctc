        ...
        <div class="overflow-x-auto">
            <table class="admin-table min-w-full">
                ...
                <tbody class="bg-white">
                    @forelse($items as $item)
                        <tr>
                            ...
                            <td class="text-right text-sm">
                                ...
                                <form action="{{ route('admin-dashboard.gallery.destroy', $item) }}" method="post" class="inline" onsubmit="return confirm('Remove this image from the gallery?');">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center text-gray-500 py-10">No gallery images yet. <a href="{{ route('admin-dashboard.gallery.create') }}" class="text-admin-teal hover:underline">Add one</a>.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
