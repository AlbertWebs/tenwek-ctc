...
<body class="h-screen overflow-hidden bg-admin-bg text-admin-dark antialiased" x-data="{ sidebarOpen: false }">
    <div class="flex h-screen">
        ...
        <div class="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
            ...
            <header class="shrink-0 z-20 flex h-16 items-center justify-between gap-4 border-b border-gray-200 bg-admin-surface px-4 shadow-sm lg:px-8">
