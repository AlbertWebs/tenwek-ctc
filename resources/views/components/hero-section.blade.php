...
<section
    class="relative bg-ctc-blue text-white overflow-hidden h-screen min-h-[100vh] flex items-center justify-center"
    data-ctc-hero
>
    @if($useCarousel)
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex justify-center">
        <div class="relative max-w-3xl w-full px-6 sm:px-10 py-10 sm:py-12">
            ...
            <div class="relative z-10 text-center p-3">
                <h1 id="ctc-hero-title" class="font-headline font-extrabold text-white tracking-[-0.035em] leading-[1.05] mb-5 drop-shadow-[0_18px_45px_rgba(0,0,0,0.45)]" style="font-size:clamp(2.4rem,5vw,4rem);">
                    {{ $title }}
                </h1>
            @if($subtitle)
                <p id="ctc-hero-subtitle" class="font-headline text-[0.65rem] font-bold uppercase tracking-[0.22em] mb-5">
