...
| **`/support`** | Support the CTC | Banner then cards: **Donate** (M-Pesa and Card/Stripe buttons that open payment modals), **Sponsor a Surgery**, **Equipment Needs**, **Partner With Us**. Each of the last three has a “Send enquiry” button that opens an enquiry form. Bottom CTA to contact. |
